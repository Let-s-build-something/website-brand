...
class SocialCircleModel: ViewModel() {
    ...
    companion object {
        private val demoPeople = listOf(
            ...
            NetworkItemIO("Morgan", null, 9.1f),
            ...
            NetworkItemIO("Event Host", null, 2.7f),
            ...
            NetworkItemIO("Public Speaker", null, 2.6f),
            ...
            NetworkItemIO("Cashier", null, 2.3f),
            ...
            NetworkItemIO("Taxi Dispatcher", null, 2.1f),
            ...
            NetworkItemIO("Firefighter", null, 2.6f),
